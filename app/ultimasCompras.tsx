                ...
                <View style={style.container}>
                    {ultimasCompras.map((ultimaCompra) => (
                        <View
                            ...
                            style={[
                                style.card,
                                ultimaCompra.situacao.toLowerCase() === "em andamento" && style.cardAndamento
                            ]}
                        >
                            ...
                            <View>
                                ...
                                <View style={style.linha}>
                                    ...
                                    <View style={style.conteudo}>
                                        <Text style={style.title}>{ultimaCompra.title}</Text>
                                        <br></br>

                                        <View style={style.infos}>
                                            <Text style={style.preco}>{ultimaCompra.preco}</Text>
                                            <Text style={style.situacao}>{ultimaCompra.situacao}</Text>
                                        </View>
                                    </View>
